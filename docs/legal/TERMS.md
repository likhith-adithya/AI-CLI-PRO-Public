...
The Extension source code is licensed under the Apache License 2.0. The AI CLI PRO name, logo, and original branding assets are the exclusive intellectual property of the developer. All other title, ownership rights, and intellectual property rights in and to the Extension (excluding third-party content) remain with the developer. Trademarks and logos related to third-party tools are the property of their respective owners.
